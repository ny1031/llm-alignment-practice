...
COMPLETIONS_URL="http://instance-32550.prj-2516.ws-1223.svc.cluster.local:8080/v1/chat/completions"
...
python3 eval.py --model_name $MODEL_NAME --completions_url $COMPLETIONS_URL --result_dir $RESULT_DIR \
    ...
    >> $LOG_DIR/eval_${MODEL_NAME}_${ENDPOINT_TYPE}_${TASK}_${DATE}.log 2>&1